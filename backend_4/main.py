...
frontend_urls = os.getenv("FRONTEND_URLS", "http://localhost:5173,http://localhost:3000,https://snaplink-iota.vercel.app,https://pretty-laughter-production.up.railway.app").split(",")
